...
- [~] Milestone 2 — allocation reconciliation and exact `job_id -> stub_id` binding landed; automated controller snapshot ingestion and historical observations remain.
